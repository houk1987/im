...
//                }
    ...
    private void addRegisterLink(){
        registerLinkLabel = JLabelFactory.createLinkLabel("注册帐号", new Font("微软雅黑",Font.PLAIN, 12), "#66a1e3", "http://" + ConnectionManager.getConnection().getHost() + ":9090/plugins/userservice/qqRegister.htm");
